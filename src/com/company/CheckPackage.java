...
public class CheckPackage extends JFrame {
    CheckPackage(){
        ...
        String[] package3=new String[]{"BRONZE PACKAGE","6 Days and 5 Nights","Return Airfare","Free Clubbing Horse, Riding and Other Games","Welcome Drinks on Arrival","Daily Buffet","Stay in 5 Star Hotel","BBQ Dinner","BOOK NOW","Winter Special","Rs 32000/-","package3.jpg"};
    ...
    public JPanel createPackage(String[] pack){
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("com/company/Icons/"+pack[11]));
